...
function _renderPatternRow(p){
  ...
  return '<div class="pattern-row" data-idx="' + p.idx + '">'
    ...
    +     '<button class="pattern-download-btn pattern-row-dl-btn" onclick="downloadPatterns('md',' + p.idx + ')">.md</button>'
    +     '<button class="pattern-download-btn pattern-row-dl-btn" onclick="downloadPatterns('txt',' + p.idx + ')">.txt</button>'
    +     '<button class="pattern-download-btn pattern-row-dl-btn" onclick="downloadPatterns('docx',' + p.idx + ')">.docx</button>'
    +     '<button class="pattern-download-btn pattern-row-dl-btn" onclick="downloadPatterns('pdf',' + p.idx + ')">.pdf</button>'
